...
time='2021年6月13号'
    [[ $Choice = 1 ]] && Download -net "fleid=644522238266159104&puid=176246092" "$1.zip" 27427 aebf5982c0292e80f60ce1d3551a2ee3 "$1.zip"
;;
...
BootAnimation_Screen2)
    if [[ $2 = Harmony_OS ]]; then
        ...
        Download -net "fleid=606049692070088704&puid=176246092" "$2.zip" 9387253 e9888de8d5458b1265e2b912abc02955 "$2.zip"
