Configuration=2021052923
Magisk_Warehouse_version=2021052923
App_Store_version=2021052923
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "igvOFplbx1g" "$1.zip" 3461516 71382a57c7e7861b4695d2089e5422a9 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ipRRhplc4vi" "$1.zip" 728977 54cee829bcfe5cd559ed80b811356647 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ic585plcmej" "$1.zip" 17581934 c7d15b82fd8cfb17cc4863e7ef2c20ff "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "i2xTVplcqhg" "$1.zip" 42969182 161d8ef82ff9e16c91c92e6439b4f4b4 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iYIBoplcslc" "$1.zip" 234416 832f123b85f4f17873506471ee24ecb5 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ivk6Splcwid" "$1.zip" 53460953 d7d0b8b1a67f63d2fe9896d353d2c2af "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iP052plczeh" "$1.zip" 1283401 6164aacd34215cffc9b23ab1f30e079c "$1.zip"
;;
...
description="$name"
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iThvKpld0xc" "$1.zip" 1125623 6a76d73f76635d53395539e13c72af07 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iv5hGpld2de" "$1.zip" 1422609 06babbf3d8606d5903d3af28b257da3a "$1.zip"
;;
...
description='一些玄学优化'
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ixlBtpld3qd" "$1.apk" 19185369 4858a32066bcac5c8cc695dcf6de0395 "$1.apk"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iKls9pld5ze" "$1.zip" 129565 8a9c232de79f40c3355e365cade0b068 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ixjs7plddqd" "$1.zip" 23632948 51130c50862f9b9791b1d3ebaae66648 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ipAGEpldbza" "$1.zip" 15826 9fbd92a81175a45eeac4a8cdf0c07440 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "i1725pldfxc" "$1.zip" 48984 eb82f672596c5cc6811642421f89fd8c "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ixYYVpldgyj" "$1.zip" 3155 2b87f38a763dcc82277fbd6dee776965 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "i7Edrpldhne" "$1.zip" 31250 334935c6feef7cb2bdb8f26635930443 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "isIIUpldj4h" "$1.zip" 55415 cd4efaa0ba3bb2a36c0b5436b6c5ca3a "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iQMjupldosb" "$1.zip" 732022 c88194b23dc79665725d6aad47851faf "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iGAeXpldqid" "$1.apk" 7562544 c70b5ca61f0093f01b2d1b86b8f26156 "$1.apk" 2.0-11 178
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iSF1Qpldzdc" "$1.apk" 179024 f90dee479057ead98f57deac3fb12168 "$1.apk" 1.6.2 102
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "i6WeHple3wf" "$1.zip" 9133455 daacac30d0c4870dbfc8fe796d24f15e "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iV4dAple96f" "$1.zip" 16690 9baf11b6e4ce8dd43f92c8764e1adb5f "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "izjJ3ple95e" "$1.zip" 8896 c138428e8abe7bbd7c6f5748c353c659 "$1.zip"
;;
...
if [[ $Riru_version -eq 2 ]]; then
    #riru-core-21.3
    [[ $Choice = 1 ]] && Download -lz "immlnplekrc" "$1-v21.3.zip" 541223 6c395f29a2cc50ae4f4efdaf87f78ca3 "$1-v21.3.zip"
elif [[ $Riru_version -eq 1 ]]; then
    [[ $Choice = 1 ]] && Download -lz "ieilAplellc" "$1.zip" 234988 25e2f01e5fabc1e7053d23aa1ba7167c "$1.zip"
fi
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iMprhplensb" "$1.zip" 110511 56f16e1af1c23d366932f0e99579e9e3 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iOH33plepxi" "$1.zip" 1371819 74360fe397f80f4c1c588d0b53d59598 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iXiHYpleqlc" "$1.zip" 1220444 59b03e73329d88df922c2569a2656733 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iQcMppletba" "$1.zip" 1213292 5e9fba5f9b6104d1a5cfd0c6535ff26b "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iha90pletaj" "$1.zip" 1218749 30a4efe7b2eab2ebc1a752bc0b51a9a8 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "idxl9plexbe" "$1.zip" 4301 539ab990564c6f36efa0320a28dc9ce6 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iGhCyplezch" "$1.zip" 54980 64f4636819924ff2f7471e61516cebdb "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iuPouplf45a" "$1.zip" 7374 f898f49917c231fae144e1ba60a58a14 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iBuitplf85e" "$1.zip" 9833244 f1928bb32f940b7cb3ccff0c84178f3c "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iBR1Mplfdih" "$id.txt" 867016 c968d8cebc8e3b84870e8e3248854be5 "$id.txt"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ivAEnplferc" "$1.zip" 4604 0c80645bedc55ef88012bb7a7411c4a1 "$1.zip"
;;
...
description='字体模块'
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iY9jOplfkxe" "$1.zip" 5730560 6b6b310f616b9877c70af399bf86b3b4 "$1.zip"
;;
...
description='黑鲨字体1.0'
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "is3tjplfnxc" "$1.zip" 11818088 92214d4a5a5b84c6ea7e3438294f5d10 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iBRXpplfscb" "$1.zip" 60131628 91aca7dbd08a18ede807e9caaf1d65f1 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iKz35plfvda" "$1.zip" 83743185 e90203bea5ad241fa3b8922a1fe2d6bf "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "iqtVUplfxxc" "$1.zip" 6574 bcf9188bc1b03729765def5c8ece039b "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ibScLplfzbc" "$1.zip" 7907878 2588203be6cdfe0d03a05d5b0ec0e9d1 "$1.zip"
;;
...
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "ifye5plg0bi" "$1.zip" 3643715 4dc82ced9f17623bc287f69b2a5e42e7 "$1.zip"
;;
...
description='EDXposed框架模块管理器'
time='2021年5月29号'
    [[ $Choice = 1 ]] && Download -lz "i17mcplg67a" "$1.apk" 5181074 d46a9905d4561343b9906c8bdd21577e "$1.apk"
;;
...
"
[[ $Old_YAHFA = 1 ]] && Download -lz "i5i9nplg58f" 2861079 ebb0129db6b2080246e11a4607cad926 "riru_edxposed-4563.zip"
[[ $Old_SandHook = 1 ]] && Download -lz "iOiOBplg54b" 3092528 6791a626ef893fb2a15047eb35d88620 "riru_edxposed_sandhook-4563.zip"
;;
...
MIUI)
    MIUI -lz "i8tTnplgc8h" MIUI1.4.7.zip 6504587 ba44181b58d10929b7ae1fc3293dd659 MIUI
;;

Charging_Sound_Effect)
    versionCode=1
    [[ $Choice = 1 ]] && Download -lz "iwWOfplgdni" "$1.zip" 6297837 bb400cbb13333d3d68dc73dc4f6d3dee "$1.zip"
;;

BootAnimation_Screen1)
    BootAnimation_Screen1 -lz "ilgDEplggmf" "$1.zip" 10697488 8a69c474a8287108a1a79b01146349a7 "$1.zip" 18
;;

Zipsigner)
    Download -lz "iG4vPplghhg" "$1-1.zip" 5206525 8b75d8340b336f118d3c15db46b53cbb "$1-"
;;

payload_dumper-win64)
    [[ $Choice = 1 ]] && Download -lz "iVdl0plgiaf" "$1.zip" 6755703 20029a0740cba709789ad074949bf5fa "$1.zip"
;;
...
Xposed_rovo89)
    if [[ $2 = -install ]]; then
        ...
        SDK2=$SDK/$Type
            ...
            21)
                if [[ $Type = arm ]]; then
                    Download -lz "iOnwiplhcrc" "xposed-v$v-sdk$SDK-$Type.zip" 3480379 614d01a116809abf09cadfd7a1abc8f2 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "ic0Ouplhcxi" "xposed-v$v-sdk$SDK-$Type.zip" 5853627 0a460e9f52ddb3e9ba1f389badd7bd6e "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "iUfJZplhcza" "xposed-v$v-sdk$SDK-$Type.zip" 4012550 be4b512111cc3efc45d8cb85e07173c2 "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            22)
                if [[ $Type = arm ]]; then
                    Download -lz "iXjmZplhd1c" "xposed-v$v-sdk$SDK-$Type.zip" 3561425 80fff79c7ad85141c520e5fd0c644ec7 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "iboHKplhd6h" "xposed-v$v-sdk$SDK-$Type.zip" 5969129 4d3bac2357dd004afff54cc48cb18fff "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "iIDPLplhd9a" "xposed-v$v-sdk$SDK-$Type.zip" 4094816 050a3d6cf4468556f2f87c9526b9e30e "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            23)
                if [[ $Type = arm ]]; then
                    Download -lz "iuYsWplhdde" "xposed-v$v-sdk$SDK-$Type.zip" 4874299 9361a270336427455c7e09af5f9c6969 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "iZ97hplhdhi" "xposed-v$v-sdk$SDK-$Type.zip" 8206844 bdaee35f5c9239d399d75ca25e89db7c "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "i2Vihplhdne" "xposed-v$v-sdk$SDK-$Type.zip" 5715178 973c8a8725d7a0bcbd718ce1f8cfa31c "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            24)
                if [[ $Type = arm ]]; then
                    Download -lz "ilb1Dplhdqh" "xposed-v$v-sdk$SDK-$Type.zip" 4389429 f6fcabd71339d549699e62524f7d6c1f "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "itzWyplheeb" "xposed-v$v-sdk$SDK-$Type.zip" 8238874 1e867e70bae5e6b38cdf937b8e79df37 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "iso2Kplhegd" "xposed-v$v-sdk$SDK-$Type.zip" 5191178 44696b7092a69a263160365a6c058b41 "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            25)
                if [[ $Type = arm ]]; then
                    Download -lz "ie49yplheli" "xposed-v$v-sdk$SDK-$Type.zip" 4405400 778dd744f0dfa6bd7608ae17281c0faa "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "iIFYSplhesf" "xposed-v$v-sdk$SDK-$Type.zip" 8272548 3039d5169746025a075a3bf297af2f86 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "iN0WSplheuh" "xposed-v$v-sdk$SDK-$Type.zip" 5206379 544f993de6ec2be20583a23116c342de "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            26)
                v=90
                if [[ $Type = arm ]]; then
                    Download -lz "iBorFplhf6j" "xposed-v$v-sdk$SDK-$Type.zip" 4277017 405ee87d04741bbfbbd0a02ffb938428 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "iOJixplhf2f" "xposed-v$v-sdk$SDK-$Type.zip" 8068001 a18f89a0470b126ac5dfe7e0ed2d5d0c "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "iJJ3cplhfcf" "xposed-v$v-sdk$SDK-$Type.zip" 4770182 e68569d68dc6b9badeb2f41cd87bbe87 "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            27)
                v=90
                if [[ $Type = arm ]]; then
                    Download -lz "iRRxgplhfng" "xposed-v$v-sdk$SDK-$Type.zip" 4229826 fa6b26bec7d95b41716ebdc746e4d576 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = arm64 ]]; then
                    Download -lz "ip1Qhplhfjc" "xposed-v$v-sdk$SDK-$Type.zip" 8038926 1085eb845483523a1b5a30547f24fc46 "xposed-v$v-sdk$SDK-$Type.zip"
                elif [[ $Type = x86 ]]; then
                    Download -lz "iwUACplhfra" "xposed-v$v-sdk$SDK-$Type.zip" 4963220 69705e2d5c6e88815d7f984f69d03200 "xposed-v$v-sdk$SDK-$Type.zip"
                fi
            ;;
            *)
        ...
        case $SDK in
            ...
            *) abort "！原版Xposed不支持您的设备SDK：$SDK";;
            ...
            if [[ $Type = arm ]]; then
                Download -lz "i2Kktplhnef" "xposed-uninstaller-20180117-$Type.zip" 311568 d4d2fa1d22779d70d3be10a0b920aaea "xposed-uninstaller-20180117-$Type.zip"
            elif [[ $Type = arm64 ]]; then
                Download -lz "iSDIcplhngh" "xposed-uninstaller-20180117-$Type.zip" 311568 d4d2fa1d22779d70d3be10a0b920aaea "xposed-uninstaller-20180117-$Type.zip"
            elif [[ $Type = x86 ]]; then
                Download -lz "iYz82plhnhi" "xposed-uninstaller-20180117-$Type.zip" 455283 87846dd6c7fe48eabbe2763c4dd6cb86 "xposed-uninstaller-20180117-$Type.zip"
            fi
        fi
;;
...
Installation_lion)
    version=3.7.5-miui
    versionCode=42
    [[ $Choice = 1 ]] && Download -lz "i1BLdplhtfc" "Installation_lion.apk" 1869340 865a0a9a40d289a36e9a8ee17bb6e774 "Installation_lion.apk"
;;

com.miui.miwallpaper)
    version='ALPHA-2.6.205-03082129-ogl'
    versionCode=206000205
    [[ $Choice = 1 ]] && Download -lz "ikMWGpli2zg" "$1.apk" 56406991 124a1dd155294d05827264f253ce860f "$1.apk"
;;

com.miui.miwallpaper.snowmountain)
    version='ALPHA-2.6.151-12171721-ogl'
    versionCode=206000151
    [[ $Choice = 1 ]] && Download -lz "imlqipli1je" "$1.apk" 89837236 f5c971e0e6735ab653b4dd8f0bbbc6ac "$1.apk"
;;

Install_Applet)
    name=Applet
    versionCode=73
    Install_Applet -lz "izRwNpli34b" "$name.zip" 7362205 4b72333cf5ca2edff20743f58de71cbb "$name" $versionCode
;;

binwalk)
    version=2.3.1
    Download -lz "id7yMpli46j" "$1.zip" 39656863 023e3f4d48ecf496a67d283c071d3129 "$1.zip"
;;
